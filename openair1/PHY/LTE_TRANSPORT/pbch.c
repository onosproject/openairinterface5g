                       ...
                       uint8_t frame_mod4)
{
  ...
  x2 = frame_parms->Nid_cell; //this is c_init in 36.211 Sec 6.6.1
  //[IRTGS 30.05.2018] scrambling for FeMBMS
                 ...
                 uint8_t frame_mod4)
{
  ...
  //[IRTGS 20180620]: output frame_mod4
  //LOG_I(PHY,"[PBCH] frame type/Ncp: %d %d\n",frame_parms->frame_type, frame_parms->Ncp);
  //LOG_I(PHY,"[PBCH] frame_mod4 =  %d\n",frame_mod4);
