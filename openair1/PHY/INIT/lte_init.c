...
//#ifndef CUDA
//      cudaMallocHost((void **)eNB_common_vars->txdataF[eNB_id], frame_parms->nb_antennas_tx*sizeof(int32_t*));
//#else
...
//#ifndef CUDA
        //cudaMallocHost((void **)&eNB_common_vars->txdataF[eNB_id][i], FRAME_LENGTH_COMPLEX_SAMPLES_NO_PREFIX*sizeof(int32_t) );
        //memset( eNB_common_vars->txdataF[eNB_id][i], 0, FRAME_LENGTH_COMPLEX_SAMPLES_NO_PREFIX*sizeof(int32_t) );
//#else
...
//#ifndef CUDA
      //cudaMallocHost((void **) &eNB_common_vars->rxdata_7_5kHz[eNB_id],frame_parms->nb_antennas_rx*sizeof(int32_t*));
      //cudaMallocHost((void **) &eNB_common_vars->rxdataF[eNB_id], frame_parms->nb_antennas_rx*sizeof(int32_t*));
//#else
...
#endif //USER_MODE
//#ifndef CUDA
//        cudaMallocHost((void **)&eNB_common_vars->rxdata_7_5kHz[eNB_id][i], frame_parms->samples_per_tti*sizeof(int32_t));
        //memset( eNB_common_vars->rxdata_7_5kHz[eNB_id][i],0,frame_parms->samples_per_tti*sizeof(int32_t) );
//        cudaMallocHost((void **)&eNB_common_vars->rxdataF[eNB_id][i], 2*sizeof(int32_t)*(frame_parms->ofdm_symbol_size*frame_parms->symbols_per_tti)  );
        //memset( eNB_common_vars->rxdataF[eNB_id][i],0, 2*sizeof(int32_t)*(frame_parms->ofdm_symbol_size*frame_parms->symbols_per_tti) );
//#else
...
//#endif
  ...
  for (UE_id=0; UE_id<NUMBER_OF_UE_MAX; UE_id++) {
    ...
    //FIXME
//#ifdef CUDA
    //cudaMallocHost((void **)eNB_pusch_vars[UE_id],NUMBER_OF_UE_MAX*sizeof(LTE_eNB_PUSCH));
//    eNB_pusch_vars[UE_id] = (LTE_eNB_PUSCH*)malloc( NUMBER_OF_UE_MAX*sizeof(LTE_eNB_PUSCH) );
//#else
...
//#ifndef CUDA
//        cudaMallocHost((void **)&eNB_pusch_vars[UE_id]->rxdataF_comp[eNB_id], frame_parms->nb_antennas_rx*sizeof(int32_t*));
//#else
...
//#ifndef CUDA
//          cudaMallocHost((void **)&eNB_pusch_vars[UE_id]->rxdataF_comp[eNB_id][i], sizeof(int32_t)*frame_parms->N_RB_UL*12*frame_parms->symbols_per_tti  );
          //memset( eNB_pusch_vars[UE_id]->rxdataF_comp[eNB_id][i],0, sizeof(int32_t)*frame_parms->N_RB_UL*12*frame_parms->symbols_per_tti );
//#else
