               ...
               )
{
  ...
  *sib1 = &bcch_message->message.choice.c1.choice.systemInformationBlockType1;
  ...
  memset(&PLMN_identity_info,0,sizeof(LTE_PLMN_IdentityInfo_t));
  ...
  PLMN_identity_info.cellReservedForOperatorUse=LTE_PLMN_IdentityInfo__cellReservedForOperatorUse_notReserved;
