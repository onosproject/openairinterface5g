...
void RCconfig_flexran()
{
  ...
  int32_t tdd_config, tdd_config_s, eutra_band, uplink_frequency_offset,
    ...
    e_LTE_SL_CP_Len_r12            rxPool_sc_CP_Len;
    e_LTE_SL_PeriodComm_r12        rxPool_sc_Period;
    e_LTE_SL_CP_Len_r12            rxPool_data_CP_Len;
    long                           rxPool_ResourceConfig_prb_Num;
    long                           rxPool_ResourceConfig_prb_Start;
    long                           rxPool_ResourceConfig_prb_End;
    LTE_SL_OffsetIndicator_r12_PR  rxPool_ResourceConfig_offsetIndicator_present;
    long                           rxPool_ResourceConfig_offsetIndicator_choice;
    LTE_SubframeBitmapSL_r12_PR    rxPool_ResourceConfig_subframeBitmap_present;
    ...
    //SIB19
    //for discRxPool
    LTE_SL_CP_Len_r12_t            discRxPool_cp_Len;
    e_LTE_SL_DiscResourcePool_r12__discPeriod_r12                   discRxPool_discPeriod;
    ...
    LTE_SL_OffsetIndicator_r12_PR  discRxPool_ResourceConfig_offsetIndicator_present;
    long                           discRxPool_ResourceConfig_offsetIndicator_choice;
    LTE_SubframeBitmapSL_r12_PR    discRxPool_ResourceConfig_subframeBitmap_present;
    ...
    //for discRxPoolPS
    LTE_SL_CP_Len_r12_t            discRxPoolPS_cp_Len;
    e_LTE_SL_DiscResourcePool_r12__discPeriod_r12                   discRxPoolPS_discPeriod;
    ...
    LTE_SL_OffsetIndicator_r12_PR  discRxPoolPS_ResourceConfig_offsetIndicator_present;
    long                           discRxPoolPS_ResourceConfig_offsetIndicator_choice;
    LTE_SubframeBitmapSL_r12_PR    discRxPoolPS_ResourceConfig_subframeBitmap_present;
