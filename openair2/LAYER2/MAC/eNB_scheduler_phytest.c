...
//------------------------------------------------------------------------------
{
  ...
  for (CC_id=0; CC_id<MAX_NUM_CCs; CC_id++) {
    ...
    */
    ...
    LOG_D(MAC,"schedule_ue_spec_phy_test: subframe %d/%d: nb_rb=%d, TM=%d, TBS=%d, mcs=%d harq_pid=%d (rb_alloc=%x, N_RB_DL=%d) pdu_number = %d \n", frameP, subframeP, nb_rb, transmission_mode, TBS, mcs, harq_pid, rb_alloc, N_RB_DL, dl_req->number_pdu);
