...
//
#define RXEN			1		// bit 0 : 1 bit
#define TXEN			2		// bit 1 : 1 bit

#define TXLPFENMASK		4		// bit 2 : 1 bit
#define TXLPFEN			4

#define TXLPFMASK		(15<<3)	// bit 3 : 4 bits
#define TXLPF14			0
#define TXLPF10			(1<<3)
#define TXLPF7			(2<<3)
#define TXLPF6			(3<<3)
...
#define RXLPFENMASK		(1<<7)	// bit 7 : 1 bit
#define RXLPFEN			128

#define RXLPFMASK		(15<<8)	// bit 8 : 4 bits
#define RXLPF14			0
#define RXLPF10			(1<<8)
#define RXLPF7			(2<<8)
#define RXLPF6			(3<<8)
...
#define LNAMASK			(3<<12)	// bit 12 : 2 bits
#define LNADIS			0
#define LNA1ON			(1<<12)
#define LNA2ON			(2<<12)
#define LNA3ON			(3<<12)

#define LNAGAINMASK		(3<<14)	// bit 14 : 2 bits
#define LNAByp			(1<<14)
#define LNAMed			(2<<14)
#define LNAMax			(3<<14)

// RFBBMASK: enable different loopback modes for calibration and testing. Use RFBBNORM for normal operation
#define RFBBMASK		(7<<16)	// bit 16 : 3 bits
#define RFBBNORM		0
...
#define RXLPFMODEMASK	(3<<19)	// bit 19 : 2 bits
#define RXLPFNORM		0
#define RXLPFBYP		(1<<19)
#define RXLPFBPY2		(3<<19)

#define TXLPFMODEMASK	(1<<21)	// bit 21 : 1 bit
#define TXLPFNORM		0
#define TXLPFBYP		(1<<21)

#define RXOUTSW			(1<<22)	// bit 22 : 1 bit

#define DMAMODE_TRXMASK	(3<<23)	// bit 23 : 2 bits
...
//typedef struct
//{
//	uint32_t	syr_magic[MAX_ANTENNAS];	// test SYRTEM magic number = 19951215 (0x01 30 6E 6F)
//	uint32_t	syr_cmd[MAX_ANTENNAS];		// SPI_WRITE, SPI_READ, READ_LMS6002_REG
//	uint32_t	syr_spi_reg[MAX_ANTENNAS];	// REGISTER ADDRESS for SPI_WRITE, SPI_READ
//	uint32_t	syr_spi_data[MAX_ANTENNAS];	// DATA for SPI_WRITE
//
//} syr_rf_t;
