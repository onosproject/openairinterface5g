...
//				if ( (i < 10) && (aa == 0))
//				{
//					printf("i=%d rx_sig[I]=0x%2.2x, rx_sig[Q]=0x%4.4x\n", 
//						i, 
//						*rx_sig[aa+j*MAX_ANTENNAS][i*2], 
//						*rx_sig[aa+j*MAX_ANTENNAS][i*2+1]);
//				}
			}
		}
	}
