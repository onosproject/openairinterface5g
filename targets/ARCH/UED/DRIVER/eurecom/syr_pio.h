...
#define	PIO_CFG_CALIB_SOFTRESET						0x00	// void reset_lms(unsigned int device)
#define	PIO_CFG_CALIB_INIT							0x01	// int exmimo_device_init(unsigned int device)

#define PIO_CFG_CALIB_SET_TX_FREQ_NINT				0x02	//
#define PIO_CFG_CALIB_SET_TX_FREQ_NFRAC22			0x03	//
#define PIO_CFG_CALIB_SET_TX_FREQ_NFRAC15			0x04	//
#define PIO_CFG_CALIB_SET_TX_FREQ_NFRAC7			0x05	//
#define PIO_CFG_CALIB_SET_TX_FREQ_LOAD				0x06	//

#define PIO_CFG_CALIB_SET_RX_FREQ_NINT				0x07	//
#define PIO_CFG_CALIB_SET_RX_FREQ_NFRAC22			0x08	//
#define PIO_CFG_CALIB_SET_RX_FREQ_NFRAC15			0x09	//
#define PIO_CFG_CALIB_SET_RX_FREQ_NFRAC7			0x0A	//
#define PIO_CFG_CALIB_SET_RX_FREQ_LOAD				0x0B	//

#define PIO_CFG_CALIB_DC_OFF_CANCEL_LPF_TUNING_MOD	0x0C	//
#define PIO_CFG_CALIB_LPF_BANDWIDTH_TUNING			0x0D	//
#define PIO_CFG_CALIB_DC_OFF_CANCEL_TXLPF_I			0x0E	//
#define PIO_CFG_CALIB_DC_OFF_CANCEL_TXLPF_Q			0x0F	//
#define PIO_CFG_CALIB_DC_OFF_CANCEL_RXLPF_I			0x10	//
#define PIO_CFG_CALIB_DC_OFF_CANCEL_RXLPF_Q			0x11	//
#define PIO_CFG_CALIB_DC_OFF_CANCEL_RXVGA2_DC		0x12	//
#define PIO_CFG_CALIB_DC_OFF_CANCEL_RXVGA2_Ia		0x13	//
#define PIO_CFG_CALIB_DC_OFF_CANCEL_RXVGA2_Qa		0x14	//
#define PIO_CFG_CALIB_DC_OFF_CANCEL_RXVGA2_Ib		0x15	//
#define PIO_CFG_CALIB_DC_OFF_CANCEL_RXVGA2_Qb		0x16	//
