...
#define SOFTMODEM_LTEUE_BIT           (1<<22)
#define SOFTMODEM_NRUE_BIT            (1<<23)
...
#define IS_SOFTMODEM_LTE             ( (get_softmodem_optmask() & SOFTMODEM_LTEUE_BIT) || (get_softmodem_optmask() & SOFTMODEM_ENB_BIT) )
#define IS_SOFTMODEM_UE              ( (get_softmodem_optmask() & SOFTMODEM_LTEUE_BIT) || (get_softmodem_optmask() & SOFTMODEM_NRUE_BIT) )
