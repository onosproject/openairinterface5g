...
typedef struct gNB_RRC_KPI_STATS_s {
  uint32_t nr_rrc_conn_estab_att_sum; /*RRC.ConnEstabAtt.sum*/
  uint32_t nr_rrc_conn_estab_succ_sum; /*RRC.ConnEstabSucc.sum*/
  uint32_t nr_rrc_conn_reestab_att_sum; /*RRC.ConnReEstabAtt.sum*/
  uint32_t nr_rrc_conn_mean; /*RRC.ConnMean*/
  uint32_t nr_rrc_conn_max; /*RRC.ConnMax*/
} gNB_RRC_KPI_STATS;
#endif
