...
then
    ...
    echo "declare -x http_proxy=http://centos5g:1249124912@10.0.58.88:8080" >> $VM_CMDS
    echo "declare -x https_proxy=https://centos5g:1249124912@10.0.58.88:8080" >> $VM_CMDS
