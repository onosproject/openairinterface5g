...
// nFAPI NR Message IDs
typedef enum {
    NFAPI_NR_DL_CONFIG_REQUEST = 0x0080,
    NFAPI_NR_UL_CONFIG_REQUEST = 0x0081,
    NFAPI_NR_RACH_INDICATION = 0x0403
} nfapi_nr_message_id_e;
...
typedef enum {
    ...
    NFAPI_NR_DL_CONFIG_DCI_UL_PDU_TYPE
} nfapi_nr_dl_config_pdu_type_e;

typedef enum {
    NFAPI_NR_UL_CONFIG_ULSCH_PDU_TYPE = 0,
    NFAPI_NR_UL_CONFIG_ULSCH_CQI_RI_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_ULSCH_HARQ_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_ULSCH_CQI_HARQ_RI_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_UCI_CQI_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_UCI_SR_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_UCI_HARQ_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_UCI_SR_HARQ_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_UCI_CQI_HARQ_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_UCI_CQI_SR_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_UCI_CQI_SR_HARQ_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_SRS_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_HARQ_BUFFER_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_ULSCH_UCI_CSI_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_ULSCH_UCI_HARQ_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_ULSCH_CSI_UCI_HARQ_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_NULSCH_PDU_TYPE,
    NFAPI_NR_UL_CONFIG_NRACH_PDU_TYPE,
...
typedef struct
{
    ...
    nfapi_uint16_tlv_t nrarfcn; // TODO: change this to uint32_t
...
typedef struct {
    ...
    nfapi_uint16_tlv_t  ssb_scg_position_in_burst;  // in servingcellconfigcommon 
...
typedef struct {
    ...
    nfapi_int16_tlv_t   preambleReceivedTargetPower;
} nfapi_nr_rach_config_t;
#define NFAPI_NR_PRACH_CONFIG_INDEX 0x6002
#define NFAPI_NR_PRACH_MSG1_FDM 0x6003
#define NFAPI_NR_PRACH_MSG1_FREQ_START 0x6004
#define NFAPI_NR_PRACH_ROOT_SEQUENCE_INDEX 0x6005
#define NFAPI_NR_PRACH_MSG1_SUBCARRIER_SPACING 0x6006
#define NFAPI_NR_PRACH_RESTRICTED_SET_CONFIG 0x6007
#define NFAPI_NR_PRACH_MSG3_TRANSFORM_PRECODING 0x6008
#define NFAPI_NR_PRACH_ZERO_CORR_ZONE_CONFIG 0x6009
#define NFAPI_NR_PRACH_PREAMBLE_RECEIVED_TARGET_POWER 0x6010
...
#define NFAPI_NR_UL_CONFIG_REQUEST_DCI_PDU_REL15_TAG 0x5031
...
#define NFAPI_NR_DL_CONFIG_REQUEST_DCI_PDU_REL15_TAG 0x5032
//#define NFAPI_NR_DL_CONFIG_REQUEST_DCI_DL_PDU_REL15_TAG 0x????

#define NFAPI_NR_RACH_INDICATION_BODY_TAG 0x6000
...
typedef struct {
    ...
    uint8_t aggregation_level;
    uint8_t n_rb; //TODO: change this from uint8_t to int8_t in NFAPI
    uint8_t n_symb;
    int8_t rb_offset;//TODO: change this from int8_t to uint8_t in NFAPI
...
#define NFAPI_NR_DL_CONFIG_REQUEST_PDCCH_PDU_REL15_TAG 0x5031
...
#define NFAPI_NR_DL_CONFIG_REQUEST_DLSCH_PDU_REL15_TAG 0x5030
...
#define NFAPI_NR_DL_CONFIG_REQUEST_BODY_REL_15_TAG 0x5026
...
typedef struct {
    ...
    uint16_t nbOfPRBs;
    uint16_t startingSymbol;
    uint16_t nbOfSymbols;
} nfapi_nr_ul_config_sr_information_rel15_t;
#define NFAPI_NR_UL_CONFIG_REQUEST_SR_INFORMATION_REL15_TAG 0x2016

typedef struct {
    nfapi_nr_ul_config_sr_information_rel15_t sr_information_rel15;
} nfapi_nr_ul_config_sr_information;

typedef struct {
    nfapi_tl_t tl;
    uint32_t handle;
    uint16_t rnti;
} nfapi_nr_ul_config_ue_information_rel15_t;
#define NFAPI_NR_UL_CONFIG_REQUEST_UE_INFORMATION_REL15_TAG 0x2013

typedef struct {
    nfapi_nr_ul_config_ue_information_rel15_t ue_information_rel15;
} nfapi_nr_ul_config_ue_information;

typedef struct {
    nfapi_nr_ul_config_ue_information ue_information;
    nfapi_nr_ul_config_sr_information sr_information;
} nfapi_nr_ul_config_uci_sr_pdu;

typedef struct {
    nfapi_tl_t tl;
    uint16_t n_pucch_1_0;
    uint8_t harq_size;
} nfapi_nr_ul_config_harq_information_rel15_fdd_t;
#define NFAPI_NR_UL_CONFIG_REQUEST_HARQ_INFORMATION_REL15_FDD_TAG 0x2019

typedef struct {
    nfapi_nr_ul_config_harq_information_rel15_fdd_t harq_information_rel15_fdd;
} nfapi_nr_ul_config_harq_information;

typedef struct {
    nfapi_nr_ul_config_ue_information ue_information;
    nfapi_nr_ul_config_harq_information harq_information;
} nfapi_nr_ul_config_uci_harq_pdu;

typedef struct {
    nfapi_nr_ul_config_ue_information ue_information;
    nfapi_nr_ul_config_sr_information sr_information;
    nfapi_nr_ul_config_harq_information harq_information;
} nfapi_nr_ul_config_uci_sr_harq_pdu;
...
# define NFAPI_NR_UL_CONFIG_REQUEST_ULSCH_PDU_REL15_TAG 0x5027
...
#define NFAPI_NR_UL_CONFIG_REQUEST_BODY_REL_15_TAG 0x5028
...
typedef struct {
    ...
    uint32_t handle;
    uint16_t rnti;
} nfapi_nr_rx_ue_information_rel15_t;
#define NFAPI_NR_RX_UE_INFORMATION_REL15_TAG 0x6000
...
typedef struct{
    ...
    uint16_t startingSymbol;
    uint16_t nbOfSymbols;
}nfapi_nr_sr_information_rel15_t;

typedef struct {
    uint16_t                                instance_length;
    nfapi_nr_rx_ue_information_rel15_t      rx_ue_information;
    nfapi_nr_sr_information_rel15_t         sr_information_rel15;
} nfapi_nr_sr_indication_pdu_t;

typedef struct{
    nfapi_tl_t tl;
    uint16_t number_of_srs;
    nfapi_nr_sr_indication_pdu_t* sr_pdu_list;
}nfapi_nr_sr_indication_body_t;
#define NFAPI_NR_SR_INDICATION_BODY_TAG 0x6001

typedef struct{
    nfapi_p7_message_header_t header;
    uint16_t sfn_sf;
    nfapi_nr_sr_indication_body_t sr_indication_body;
    nfapi_vendor_extension_tlv_t vendor_extension;
}nfapi_nr_sr_indication_t;



//#define NFAPI_NR_DL_CONFIG_REQUEST_BODY_REL_15_TAG 0x5029
