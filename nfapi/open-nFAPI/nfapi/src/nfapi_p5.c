...
{
	nfapi_nr_config_request_t *pNfapiMsg = (nfapi_nr_config_request_t*)msg;
		...
		return ( push8(pNfapiMsg->num_tlv, ppWritePackedMsg, end) &&
				 ...
				 pack_tlv(NFAPI_NR_NFAPI_NRARFCN_TAG, &(pNfapiMsg->nfapi_config.nrarfcn), ppWritePackedMsg, end, &pack_uint16_tlv_value) &&

				 pack_tlv(NFAPI_NR_SUBFRAME_CONFIG_DUPLEX_MODE_TAG, &(pNfapiMsg->subframe_config.duplex_mode), ppWritePackedMsg, end, &pack_uint16_tlv_value) &&
	             pack_tlv(NFAPI_NR_SUBFRAME_CONFIG_NUMEROLOGY_INDEX_MU_TAG,&(pNfapiMsg->subframe_config.numerology_index_mu),ppWritePackedMsg, end, &pack_uint16_tlv_value)&&
				 pack_tlv(NFAPI_NR_SUBFRAME_CONFIG_DL_CYCLIC_PREFIX_TYPE_TAG, &(pNfapiMsg->subframe_config.dl_cyclic_prefix_type), ppWritePackedMsg, end, &pack_uint16_tlv_value) &&

				 pack_tlv(NFAPI_NR_RF_CONFIG_DL_CARRIER_BANDWIDTH_TAG, &(pNfapiMsg->rf_config.dl_carrier_bandwidth), ppWritePackedMsg, end, &pack_uint16_tlv_value) &&
				 pack_tlv(NFAPI_NR_RF_CONFIG_UL_CARRIER_BANDWIDTH_TAG, &(pNfapiMsg->rf_config.ul_carrier_bandwidth), ppWritePackedMsg, end, &pack_uint16_tlv_value) &&

				 pack_tlv(NFAPI_NR_SCH_CONFIG_PHYSICAL_CELL_ID_TAG, &(pNfapiMsg->sch_config.physical_cell_id), ppWritePackedMsg, end, &pack_uint16_tlv_value) &&
				 pack_tlv(NFAPI_NR_SCH_CONFIG_SSB_SUBCARRIER_OFFSET_TAG, &(pNfapiMsg->sch_config.ssb_subcarrier_offset), ppWritePackedMsg, end, &pack_uint16_tlv_value) &&
				 pack_tlv(NFAPI_NR_SCH_CONFIG_SSB_POSITION_IN_BURST, &(pNfapiMsg->sch_config.ssb_scg_position_in_burst), ppWritePackedMsg, end, &pack_uint16_tlv_value) &&
				 pack_tlv(NFAPI_NR_SCH_CONFIG_HALF_FRAME_INDEX_TAG, &(pNfapiMsg->sch_config.half_frame_index), ppWritePackedMsg, end, &pack_uint16_tlv_value) &&
				 pack_tlv(NFAPI_NR_SCH_CONFIG_N_SSB_CRB, &(pNfapiMsg->sch_config.n_ssb_crb), ppWritePackedMsg, end, &pack_uint16_tlv_value) &&
...
static uint8_t unpack_config_request(uint8_t **ppReadPackedMsg, uint8_t *end, void *msg, nfapi_p4_p5_codec_config_t* config)
{
	nfapi_nr_config_request_t *pNfapiMsg = (nfapi_nr_config_request_t*)msg;
		...
		unpack_tlv_t unpack_fns[] =
		{
			...
			{ NFAPI_NR_SUBFRAME_CONFIG_DUPLEX_MODE_TAG, &pNfapiMsg->subframe_config.duplex_mode, &unpack_uint16_tlv_value},
			{ NFAPI_NR_SUBFRAME_CONFIG_DL_CYCLIC_PREFIX_TYPE_TAG, &pNfapiMsg->subframe_config.dl_cyclic_prefix_type, &unpack_uint16_tlv_value},
			{ NFAPI_NR_SUBFRAME_CONFIG_NUMEROLOGY_INDEX_MU_TAG, &pNfapiMsg->subframe_config.numerology_index_mu, &unpack_uint16_tlv_value},

			{ NFAPI_NR_RF_CONFIG_DL_CARRIER_BANDWIDTH_TAG, &pNfapiMsg->rf_config.dl_carrier_bandwidth, &unpack_uint16_tlv_value},
			{ NFAPI_NR_RF_CONFIG_UL_CARRIER_BANDWIDTH_TAG, &pNfapiMsg->rf_config.ul_carrier_bandwidth, &unpack_uint16_tlv_value},

			{ NFAPI_NR_SCH_CONFIG_PHYSICAL_CELL_ID_TAG, &pNfapiMsg->sch_config.physical_cell_id, &unpack_uint16_tlv_value},
			{ NFAPI_NR_SCH_CONFIG_SSB_SUBCARRIER_OFFSET_TAG, &pNfapiMsg->sch_config.ssb_subcarrier_offset, &unpack_uint16_tlv_value},
      		{ NFAPI_NR_SCH_CONFIG_SSB_POSITION_IN_BURST, &pNfapiMsg->sch_config.ssb_scg_position_in_burst, &unpack_uint16_tlv_value},
      		{ NFAPI_NR_SCH_CONFIG_SSB_PERIODICITY, &pNfapiMsg->sch_config.ssb_periodicity, &unpack_uint16_tlv_value},
			{ NFAPI_NR_SCH_CONFIG_HALF_FRAME_INDEX_TAG, &pNfapiMsg->sch_config.half_frame_index, &unpack_uint16_tlv_value},
			{ NFAPI_NR_SCH_CONFIG_N_SSB_CRB, &pNfapiMsg->sch_config.n_ssb_crb, &unpack_uint16_tlv_value},

			{ NFAPI_NR_NFAPI_RF_BANDS_TAG, &pNfapiMsg->nfapi_config.rf_bands, &unpack_rf_bands_value},
			{ NFAPI_NR_NFAPI_NRARFCN_TAG, &pNfapiMsg->nfapi_config.nrarfcn, &unpack_uint16_tlv_value},
	...
	//		{ NFAPI_NFAPI_NMM_UPLINK_RSSI_SUPPORTED_TAG, &pNfapiMsg->nfapi_config.nmm_uplink_rssi_supported, &unpack_uint8_tlv_value},
			...
			{ NFAPI_NR_PRACH_CONFIG_INDEX, &pNfapiMsg->rach_config.prach_ConfigurationIndex, &unpack_uint16_tlv_value},
			{ NFAPI_NR_PRACH_MSG1_FDM, &pNfapiMsg->rach_config.prach_msg1_FDM, &unpack_uint16_tlv_value},
			{ NFAPI_NR_PRACH_MSG1_FREQ_START, &pNfapiMsg->rach_config.prach_msg1_FrequencyStart, &unpack_uint16_tlv_value},
			{ NFAPI_NR_PRACH_ROOT_SEQUENCE_INDEX, &pNfapiMsg->rach_config.prach_RootSequenceIndex, &unpack_uint16_tlv_value},
			{ NFAPI_NR_PRACH_MSG1_SUBCARRIER_SPACING, &pNfapiMsg->rach_config.prach_msg1_SubcarrierSpacing, &unpack_uint16_tlv_value},
			{ NFAPI_NR_PRACH_RESTRICTED_SET_CONFIG, &pNfapiMsg->rach_config.restrictedSetConfig, &unpack_uint16_tlv_value},
			{ NFAPI_NR_PRACH_MSG3_TRANSFORM_PRECODING, &pNfapiMsg->rach_config.msg3_transformPrecoding, &unpack_uint16_tlv_value},
			{ NFAPI_NR_PRACH_ZERO_CORR_ZONE_CONFIG, &pNfapiMsg->rach_config.zeroCorrelationZoneConfig, &unpack_uint16_tlv_value},
			{ NFAPI_NR_PRACH_PREAMBLE_RECEIVED_TARGET_POWER, &pNfapiMsg->rach_config.preambleReceivedTargetPower, &unpack_int16_tlv_value},
...
static int check_unpack_length(nfapi_message_id_e msgId, uint32_t unpackedBufLen)
{
	...
	switch (msgId)
	{
		...
		case NFAPI_CONFIG_REQUEST:
			if (unpackedBufLen >= sizeof(nfapi_nr_config_request_t))
				retLen = sizeof(nfapi_nr_config_request_t);
			break;
